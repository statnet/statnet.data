...
#'
#' Mark S. Handcock, David Hunter, Carter T. Butts, Steven M. Goodreau, and
#' Martina Morris. 2003 \emph{statnet: An R package for the Statistical
#' Modeling of Social Networks} \cr \url{http://www.statnet.org} and the source
#' should be cited as:
#'
...
#'
#' @references
#' See the link above.  Newcomb T. (1961). The acquaintance
